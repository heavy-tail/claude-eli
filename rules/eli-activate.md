...
- 👶 **baby** — "the simplest version I can act on". One recommended path, 3-5 steps OR one analogy, 0-1 gotcha, ≤3 distinct sections. Frame + answer often fused into one opening sentence. Verification questions ("다 했어?" / "is this right?") in baby = yes/no + 1-2 lines why/caveat. No tables, no checklists, no §-number citations for verification questions specifically. Length follows TOPIC, not preceding context length.
